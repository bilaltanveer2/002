        ...
        setItems([
          {
            ...
            rating: 5,
            quote:
              'Virtual Digital HB rebuilt our Shopify funnel and media strategy. We scaled from 1.4x to 4.1x blended ROAS within 90 days.',
          },
        ]),
      );
  }, []);
    ...
    <section className="section section--tight">
      <div style={{ display: 'flex', justifyContent: 'space-between', gap: 24, marginBottom: 20 }}>
        <div>
          ...
          <h2 style={{ fontSize: 24, marginTop: 8, marginBottom: 6 }}>Brands that trust Virtual Digital HB</h2>
